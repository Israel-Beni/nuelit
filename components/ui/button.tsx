...
export function Button({
  ...
  const baseStyles = "relative inline-flex items-center justify-center font-bold tracking-[0.2em] uppercase w-fit transition-slow  rounded-full active:scale-95 disabled:opacity-50 disabled:pointer-events-none group overflow-hidden cursor-pointer";
